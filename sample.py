...
def main(args):
    ...
    if args.use_video:
        ...
        if args.num_classes == 1000:
            class_labels = [292, 360, 387, 974, 88, 979, 417, 279]  # 原本是207, 360, 387, 974, 88, 979, 417, 279
        else:
    ...
    if args.use_video:
        ...
        file_name = f"标签{class_labels} 种子{seed}.png"
        save_image(samples, f"Generated images/{file_name}", nrow=4, normalize=True, value_range=(-1, 1))
